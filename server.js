	...
	switch(req.url){
		case "/":
			...
			checksum_lib.genchecksum(params, PaytmConfig.key, function (err, checksum) {
                ...
                res.write('<html><head><title>Merchant Checkout Page</title></head><body><center><h1>Please do not refresh this page...</h1></center><form type="hidden" method="post" action="'+txn_url+'" name="f1">'+form_fields+'</form><script type="text/javascript">document.f1.submit();</script></body></html>');
                res.end();
			});
		break;
